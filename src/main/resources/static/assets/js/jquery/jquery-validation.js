...
// https://jqueryvalidation.org/jQuery.validator.format/
    ...
    $.extend( $.validator, {
        ...
        messages: {
            ...
            range: $.validator.format( "请输入一个值 {0} 和 {1} 字符." ),
            max: $.validator.format( "请输入小于或等于的值 {0}." ),
            min: $.validator.format( "请输入大于或等于的值 {0}." ),
            step: $.validator.format( "请输入多个 {0}." )
        },
        ...
        methods: {
            ...
            decimalCheck: function(value, element) {
                return this.optional( element ) || /^(\d*.\d*|0.\d*[1-9]\d*)/.test( value );
            },
            //小数 正负数
